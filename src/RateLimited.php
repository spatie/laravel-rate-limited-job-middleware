...
class RateLimited
{
	...
	{
		Redis::connection($this->connectionName)->throttle($this->key)->block(0)
			->allow($this->allowedNumberOfJobsInTimeSpan)->every($this->timeSpanInSeconds)
	...
	{
		$bucket = new Leaky(key: $this->key, max: $this->allowedNumberOfJobsInTimeSpan,
